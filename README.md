...
Текущая версия позволяет генерировать набор реконструкций с произвольным разбиением и искажениями смещения и наклона оси, зашумления и изменения интенсивности.
...
| is_intensity_vary            | Нужно ли делать случайные отклонения интенсивности             | bool         |
| max_intensity_variation      | Максимальное отклонение интенсивности                          | float        |  
